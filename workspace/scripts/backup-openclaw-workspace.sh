...
REPO="/home/laurovitor/.openclaw/workspace"
LOG_DIR="/home/laurovitor/.openclaw/logs"
mkdir -p "$LOG_DIR"

cd "$REPO"

# Ensure git uses the stable gh wrapper / user environment when invoked from cron.
...
# Refresh index and bail if nothing changed.
git add -A
